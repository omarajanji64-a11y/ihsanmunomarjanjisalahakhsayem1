  ...
  return (
    <footer className="bg-primary border-t border-white/5 pt-24 pb-12">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4 text-xs uppercase tracking-widest">
              <li><Link href="/about" className="text-foreground/70 hover:text-white transition-colors">About Us</Link></li>
              <li><Link href="/committees" className="text-foreground/70 hover:text-white transition-colors">Committees</Link></li>
              <li><Link href="/registration" className="text-foreground/70 hover:text-white transition-colors">Registration</Link></li>
              <li><Link href="/resources" className="text-foreground/70 hover:text-white transition-colors">Resources</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="font-serif font-bold text-white mb-8 text-sm uppercase tracking-widest">Documents</h4>
            <ul className="space-y-4 text-foreground/70 text-xs uppercase tracking-widest">
          ...
          <div>
            ...
            <ul className="space-y-6 text-xs tracking-wide">
              <li className="flex gap-4 text-foreground/70">
        ...
        <div className="border-t border-white/5 pt-10 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] uppercase tracking-[0.2em] text-foreground/70">
