    ...
    <ImageEditorContext.Provider value={contextValue}>
      ...
      <div className="fixed bottom-4 right-4 z-[120]">
        <Button
          type="button"
          size="sm"
          className={isEditorEnabled ? "bg-primary text-white" : "bg-primary/90 text-white"}
      ...
      {isAuthModalOpen && (
        <div className="fixed inset-0 z-[130] flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-sm rounded-xl border border-white/15 bg-card p-5 text-white shadow-2xl">
      ...
      {isEditorEnabled && activeImageId && (
        <div className="fixed inset-0 z-[130] flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-lg rounded-xl border border-white/15 bg-card p-5 text-white shadow-2xl">
